...
🚀 Funcionalidades (ou "O que o cérebro faz")
    ...
    3. Lógica de Clamping: Travas de segurança para evitar que o pH desafie as leis da química (0-14) [cite: 2026-02-24].
...
⚙️ Como rodar (Se você for corajoso)
    ...
    2. Abra no seu Neovim ou VS Code (obviamente).

    3. Use o arduino-cli para compilar e subir para o seu ESP32 [cite: 2026-02-24].
